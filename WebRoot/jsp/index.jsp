...
<body>
	<div class="mianCont">
		...
		<div class="lsg">
			<h1 class="logo">
				<a href="index.html"><img src="${ctx}/jsp/images/logo.png" width="217"
					height="90" /></a>
			</h1>
			...
			<div class="gouwuche">
				<div class="gouCar">
					<img src="${ctx}/jsp/images/gouimg.png" width="19" height="20"
						style="position: relative; top: 6px;" />&nbsp;|&nbsp; <strong
						class="red">0</strong>&nbsp;件&nbsp;| <strong class="red">￥
						0.00</strong> <a href="order.html">去结算</a> <img src="${ctx}/jsp/images/youjian.jpg"
						width="5" height="8" />
				</div>
				<!--gouCar/-->
				<div class="myChunlv">
		...
		<div class="pnt">
			...
			<div class="pntRight">
				...
				<div class="banner">
					<div id="kinMaxShow">
						<div>
							<a href="#"><img src="${ctx}/jsp/images/ban1.jpg" height="360" /></a>
						</div>
						<div>
							<a href="#"><img src="${ctx}/jsp/images/ban2.jpg" height="360" /></a>
						</div>
						<div>
							<a href="#"><img src="${ctx}/jsp/images/ban3.jpg" height="360" /></a>
						</div>
						<div>
							<a href="#"><img src="${ctx}/jsp/images/ban4.jpg" height="360" /></a>
						</div>
						<div>
							<a href="#"><img src="${ctx}/jsp/images/ban5.jpg" height="360" /></a>
						</div>
					</div>
					<!--kinMaxShow/-->
				</div>
		...
		<div class="rdPro">
			...
			<!--rdLeft/-->
			<div class="rdRight">
				<img src="${ctx}/jsp/images/rdRight.jpg" width="221" height="254" />
			</div>
			<!--rdRight/-->
			<div class="clears"></div>
		</div>
		<div class="floor" id="floor1">
			<c:forEach  var="item" items="${dli}" > 
				<h3 class="floorTitle">
				   	1F&nbsp;&nbsp;&nbsp;&nbsp;${item.cname} <a href="jsp/proinfo.html" class="more">更多
						&gt;</a>
				</h3>
        		<div class="hengfu">
        			<a href="${item.linkUrl}"><img src="${ctx}${item.imgPath}" width="978" height="97" /></a>
				</div>
			</c:forEach>
