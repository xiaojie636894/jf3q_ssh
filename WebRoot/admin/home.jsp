...
.item a div:nth-child(1){width:40%;}
.item a div:nth-child(2){width:60%;text-align: right;padding-right: 10px;color:#ffffff;}
...
@keyframes myfirst{0% {transform: scale(1);}50% {transform:scale(1.5);}100%{transform:scale(1);}}
	...
	<body>
		...
		<h2 style="font-weight: 600;border-left:10px solid #5CB431;padding-left: 20px;">待发货订单</h2>
		<div style="width: 80%;">
