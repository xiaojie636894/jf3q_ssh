	...
	<body>
		<div class="panel admin-panel">
			...
			<div class="body-content">
				<form method="post" class="form-x" action="role_updated.do">
					<div class="form-group">
						...
						<div class="field">
							...
							<input type="text" class="input w50"  name="role.rname" value="${role.rname }" data-validate="required:请输入角色名称" placeholder="请输入角色名称"/>
							<div class="tips"></div>
						</div>
					</div>
					<div class="clear"></div>
